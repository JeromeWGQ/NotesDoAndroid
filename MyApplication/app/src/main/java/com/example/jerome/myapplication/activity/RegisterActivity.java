...
public class RegisterActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private EditText mPasswordView, mPasswordView1;
    ...
    private void attemptRegister() {
        ...
        if (!(password.equals(password1))) {
            mPasswordView1.setError("两次密码输入不一致");
            focusView = mPasswordView;
            cancel = true;
        }
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserLoginTask(email, password,nickname);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserLoginTask(String phone, String password, String nickname) {
            this.phone = phone;
        ...
        public void startRegister() {
            if (HttpUtils.isNetworkConnected(RegisterActivity.this)) {
                //封装请求参数
                RequestParams requestParams=new RequestParams();
                requestParams.put("phone",phone);
                requestParams.put("nickname",nickname);
                requestParams.put("password",password);
                requestParams.put("passwordAgain",password);
...
//                            mPasswordView.setText("");
                    ...
                    public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
                        Toast.makeText(RegisterActivity.this,"服务器挂了",Toast.LENGTH_LONG).show();
                        showProgress(false);
                    }
                });
            } else {
                Toast.makeText(RegisterActivity.this, "没有网络连接!", Toast.LENGTH_LONG).show();
